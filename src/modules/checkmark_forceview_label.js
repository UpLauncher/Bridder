  ...
  function VerifiedBadgeWorker(parse_data) {
    ...
    if (
      ...
      if (parse_data["data"]["user"]["result"]["is_blue_verified"] == false) {
        ...
        alert("このユーザーは認証されていますが、チェックマークが表示されています。");
      }
    } else {
