(function () {
  ...
  const fixText = () => {
    ...
    document
      ...
      .forEach((container) => {
        if (
          ...
          container.textContent.includes(" 件のポスト")
        ) {
    ...
    document
      ...
      .forEach((container) => {
        if (
          container &&
          container.textContent &&
          container.textContent.includes(" X Corp.")
        ) {
          container.textContent = container.textContent.replaceAll(
            " X Corp.",
        ...
        if (container.getAttribute("data-testid") == "trend") {
          container.querySelectorAll("span").forEach((elements) => {
            if (
              ...
              elements.textContent.includes("posts")
            ) {
          ...
          if (
            ...
            if (element.parentNode && element.parentNode.parentNode) {
              ...
              if (
                element
                  .closest(
                    "a.css-175oi2r.r-6koalj.r-eqz5dr.r-16y2uox.r-1habvwh.r-13qz1uu.r-rjfia.r-1ny4l3l.r-1loqt21"
                  )
                  ?.getAttribute("aria-label") == "プレミアム"
              ) {
                element.parentNode.parentNode
    ...
    document
      .querySelectorAll(
        "span.css-1jxf684.r-bcqeeo.r-1ttztb7.r-qvutc0.r-1tl8opc"
      )
      .forEach((container) => {
        try {
          if (
        ...
        try {
          const closestContainer = container.closest(
        ...
        try {
          const closestContainer = container.closest(
            ".css-175oi2r.r-ymttw5.r-1f1sjgu.r-1loqt21.r-1ny4l3l"
          );
          if (
            (closestContainer &&
              closestContainer.getAttribute("data-testid") == "UserCell") ||
            (closestContainer &&
              closestContainer.getAttribute("data-testid") == "TypeaheadUser")
          ) {
            return;
          }
        } catch {}
        ...
        try {
          const closestContainer = container.closest(
            ".css-1rynq56.r-8akbws.r-krxsd3.r-dnmrzs"
          );
          if (
            closestContainer &&
            closestContainer.getAttribute("data-testid") == "tweetText"
          ) {
            return;
          }
        } catch {}
        ...
        try {
          const closestContainer = container.closest(
            ".css-175oi2r[aria-label=Grok]"
          );
          if (
            closestContainer &&
            closestContainer.getAttribute("aria-label") == "Grok"
          ) {
            return;
          }
        } catch {}
        ...
        try {
          ...
          if (
            closestContainer &&
            closestContainer.getAttribute("data-testid") == "socialContext"
          ) {
          }
        } catch {
          try {
        ...
        try {
          ...
          if (
            closestContainer &&
            closestContainer.getAttribute("data-testid") == "activeRoute"
          ) {
            return;
          }
        } catch {}
  ...
  chrome.storage.sync.get(["enabled", "text_mode"]).then((result: any) => {
    if (result.enabled && result.text_mode) {
      ...
      new MutationObserver(fixTitle).observe(
